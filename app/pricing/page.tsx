  ...
  const plans: Plan[] = [
    {
      ...
      description: language === "nl"
        ? "2 domeinen (zonder page resources), 1 device monitoring, 1 service monitor, PulseAI included, Reports zonder email"
      ...
      features: [
        ...
        language === "nl" ? "1 device monitoring" : "1 device monitoring",
        language === "nl" ? "1 service monitor" : "1 service monitor",
        language === "nl" ? "PulseAI included" : "PulseAI included",
        language === "nl" ? "Reports zonder email" : "Reports without email",
        language === "nl" ? "Geen status pages" : "No status pages",
        language === "nl" ? "Geen email notificaties" : "No email notifications",
    ...
    },
    {
      ...
      name: "Standard",
      description: language === "nl"
        ? "5 domeinen (full monitoring), 2 devices (full), 3 service monitors, PulseAI included, Full reports with email, 1 status page, Toolbox with DNS, Email notifications"
      ...
      currency: "eur",
      features: [
        language === "nl" ? "5 domeinen (full monitoring)" : "5 domains (full monitoring)",
        language === "nl" ? "2 devices (full)" : "2 devices (full)",
        language === "nl" ? "3 service monitors" : "3 service monitors",
        language === "nl" ? "PulseAI included" : "PulseAI included",
        language === "nl" ? "Full reports with email" : "Full reports with email",
        language === "nl" ? "1 status page" : "1 status page",
        language === "nl" ? "Toolbox with DNS" : "Toolbox with DNS",
        language === "nl" ? "Email notifications" : "Email notifications",
        language === "nl" ? "Geen Telegram notificaties" : "No Telegram notifications",
      ],
      isContactUs: false,
    },
    {
      ...
      name: "Pro",
      description: language === "nl"
        ? "10 domeinen (full monitoring), 7 devices (full), 5 service monitors, PulseAI included, Full reports with email, Multiple status pages, Full toolbox, Email & Telegram notifications, API access"
      ...
      currency: "eur",
      features: [
        language === "nl" ? "10 domeinen (full monitoring)" : "10 domains (full monitoring)",
        language === "nl" ? "7 devices (full)" : "7 devices (full)",
        language === "nl" ? "5 service monitors" : "5 service monitors",
        language === "nl" ? "PulseAI included" : "PulseAI included",
        language === "nl" ? "Full reports with email" : "Full reports with email",
        language === "nl" ? "Multiple status pages" : "Multiple status pages",
        language === "nl" ? "Full toolbox" : "Full toolbox",
        language === "nl" ? "Email & Telegram notifications" : "Email & Telegram notifications",
        language === "nl" ? "API access" : "API access",
      ],
      isContactUs: false,
    },
    {
      ...
      currency: "eur",
      features: [
        language === "nl" ? "Configure your plan:" : "Configure your plan:",
        language === "nl" ? "Domeinen: 10 (€0.50 each extra)" : "Domains: 10 (€0.50 each extra)",
        language === "nl" ? "Devices: 7 (€2.00 each extra)" : "Devices: 7 (€2.00 each extra)",
        language === "nl" ? "Services: 5 (€3.00 each extra)" : "Services: 5 (€3.00 each extra)",
        language === "nl" ? "PulseAI included" : "PulseAI included",
        language === "nl" ? "Organization roles & MFA" : "Organization roles & MFA",
        language === "nl" ? "API access & integrations" : "API access & integrations",
        language === "nl" ? "All notification channels" : "All notification channels",
        language === "nl" ? "Accessibility features" : "Accessibility features",
      ],
      isContactUs: false,
    },
  ];
