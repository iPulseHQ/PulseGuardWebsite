...
export default function BlogPage() {
  ...
  const blogPosts = [
    ...
    },
    {
      ...
      category: t("categoryBestPractices"),
      date: "2024-03-12",
      readTime: "7 min",
    ...
    },
    {
      ...
      category: t("categoryAnnouncement"),
      date: "2024-03-08",
      readTime: "4 min",
  ...
  const filteredPosts = selectedCategory === t("categoryAll")
    ? blogPosts
      ...
      <section className="pb-24 px-4 sm:px-6 lg:px-8">
        <div className="max-w-7xl mx-auto">
          ...
          {filteredPosts.length > 0 && (
            ...
            >
              <button className="h-10 px-6 border border-border/50 text-sm font-semibold rounded-md hover:bg-muted transition-all inline-flex items-center justify-center">
                {t("loadMore")}
              </button>
            </motion.div>
          )}
