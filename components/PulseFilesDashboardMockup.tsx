      ...
      <div className="p-6 md:p-12">
        <div className="grid md:grid-cols-2 gap-8 items-center">
          ...
          <div className="relative">
            ...
            <div className="relative bg-[#0F1419] border-2 border-dashed border-primary/30 rounded-2xl p-6 sm:p-8 md:p-12 text-center hover:border-primary/50 transition-all">
              <div className="flex flex-col items-center gap-4 sm:gap-6">
                ...
                <div>
                  <h3 className="text-lg sm:text-xl font-semibold text-foreground mb-2">Upload je bestanden</h3>
                  <p className="text-xs sm:text-sm text-muted-foreground">Sleep bestanden hierheen of klik om te bladeren</p>
                </div>
                ...
                <div className="pt-4 sm:pt-6 border-t border-border/30 w-full">
                  ...
                  <div className="grid grid-cols-2 sm:grid-cols-4 gap-2 sm:gap-3">
                    {['Documenten', 'Afbeeldingen', "Video's", 'Archieven'].map((type) => (
                      <div key={type} className="bg-[#0A0A0A]/50 rounded-lg p-2 sm:p-3 text-center">
                        <div className="bg-primary/5 p-1.5 sm:p-2 rounded-md mb-2 mx-auto w-fit">
                          <svg className="w-4 h-4 sm:w-5 sm:h-5 text-primary/70" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                            <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M9 12h6m-6 4h6m2 5H7a2 2 0 01-2-2V5a2 2 0 012-2h5.586a1 1 0 01.707.293l5.414 5.414a1 1 0 01.293.707V19a2 2 0 01-2 2z" />
                          </svg>
                        </div>
          ...
          <div className="space-y-4 sm:space-y-6">
            <div>
              ...
              <h2 className="text-2xl sm:text-3xl font-bold text-foreground mb-3">Veilig bestanden delen</h2>
              <p className="text-sm text-muted-foreground">Upload tot 2GB gratis. Bestanden worden automatisch verwijderd na de vervaldatum</p>
            </div>
            ...
            {/* Stats */}
            <div className="grid grid-cols-3 gap-3 sm:gap-4 pt-4 sm:pt-6 border-t border-border/30">
              <div className="text-center">
                <div className="text-xl sm:text-2xl font-bold text-primary mb-1">2GB</div>
                <div className="text-[10px] text-muted-foreground">Gratis opslag</div>
              </div>
              <div className="text-center">
                <div className="text-xl sm:text-2xl font-bold text-primary mb-1">256-bit</div>
                <div className="text-[10px] text-muted-foreground">Encryptie</div>
              </div>
              <div className="text-center">
                <div className="text-xl sm:text-2xl font-bold text-primary mb-1">∞</div>
