...
export default function FeatureShowcase() {
  ...
  const features: Feature[] = [
      ...
      preview: (
        <div className="mt-4 p-4 bg-card rounded-lg border border-border shadow-sm">
          <div className="flex items-center gap-2 mb-3">
            ...
            <span className="text-sm font-semibold text-gray-900 dark:text-white">{t("sslCertificateStatus")}</span>
          </div>
    ...
    },
    {
      ...
      preview: (
        <div className="mt-4 p-4 bg-card rounded-lg border border-border shadow-sm">
          <div className="text-xs font-semibold text-gray-900 dark:text-white mb-3">{t("monitoringLocations")}</div>
    ...
    },
    {
      ...
      preview: (
        <div className="mt-4 p-4 bg-card rounded-lg border border-border shadow-sm">
          <div className="text-xs font-semibold text-gray-900 dark:text-white mb-3">{t("dnsRecords")}</div>
    ...
    },
    {
      ...
      preview: (
        <div className="mt-4 p-4 bg-card rounded-lg border border-border shadow-sm">
          <div className="flex items-center justify-between mb-3">
            <span className="text-xs font-semibold text-gray-900 dark:text-white">{t("securityScoreLabel")}</span>
    ...
    },
    {
      ...
      preview: (
        <div className="mt-4 p-4 bg-card rounded-lg border border-border shadow-sm">
          <div className="text-xs font-semibold text-gray-900 dark:text-white mb-3">{t("pageLoadTimeline")}</div>
          <div className="flex gap-1 mb-2">
            {[30, 50, 70, 85, 95, 100].map((progress, i) => (
              <motion.div
                ...
                transition={{ delay: i * 0.1 }}
                className="flex-1 aspect-square bg-indigo-200 dark:bg-indigo-900/50 rounded border border-indigo-300 dark:border-indigo-700 flex items-center justify-center"
              >
                <span className="text-[8px] font-bold text-indigo-700 dark:text-indigo-300">{progress}%</span>
              </motion.div>
            ))}
          </div>
    ...
    },
    {
      ...
      preview: (
        <div className="mt-4 p-4 bg-card rounded-lg border border-border shadow-sm">
          <div className="text-xs font-semibold text-gray-900 dark:text-white mb-3">{t("topResources")}</div>
          <div className="space-y-2">
            {[
    ...
    },
    {
      ...
      preview: (
        <div className="mt-4 p-4 bg-card rounded-lg border border-border shadow-sm">
          <div className="text-xs font-semibold text-gray-900 dark:text-white mb-3">{t("recentIncidents")}</div>
          <div className="space-y-2">
            {[
    ...
    },
    {
      ...
      preview: (
        <div className="mt-4 p-4 bg-card rounded-lg border border-border shadow-sm">
          <div className="text-xs font-semibold text-gray-900 dark:text-white mb-3">{t("alertChannels")}</div>
          <div className="space-y-2">
            {[
              ...
              >
                <div className="flex items-center gap-2">
                  ...
                  <span className="text-xs font-medium text-gray-900 dark:text-white">{channel.name}</span>
                </div>
    ...
    },
    {
      ...
      preview: (
        <div className="mt-4 p-4 bg-card rounded-lg border border-border shadow-sm">
          <div className="text-xs font-semibold text-gray-900 dark:text-white mb-3">{t("statusWidget")}</div>
          <div className="p-3 bg-violet-50 dark:bg-violet-950/20 rounded-lg border border-violet-200 dark:border-violet-800">
            <div className="flex items-center justify-between mb-2">
              <span className="text-xs font-semibold text-gray-900 dark:text-white">{t("serviceStatus")}</span>
              <div className="flex items-center gap-1">
    ...
    },
    {
      ...
      preview: (
        <div className="mt-4 p-4 bg-card rounded-lg border border-border shadow-sm">
          <div className="text-xs font-semibold text-gray-900 dark:text-white mb-3">{t("performanceStats")}</div>
              ...
              >
                ...
                <div className="relative z-10">
                  ...
                  <h3 className={`
                    ...
                    ${shouldShowPreview ? 'text-gray-900 dark:text-white' : 'text-foreground/90 group-hover:text-foreground'}
                  `}>
                    {feature.title}
                  </h3>
                  ...
                  <p className={`
                    ...
                    ${shouldShowPreview ? 'text-gray-700 dark:text-gray-200' : 'text-muted-foreground group-hover:text-foreground/70'}
                  `}>
                    {feature.description}
                  </p>
