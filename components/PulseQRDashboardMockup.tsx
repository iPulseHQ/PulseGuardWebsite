export default function PulseQRDashboardMockup() {
  return (
    <div className="w-full max-w-6xl mx-auto rounded-2xl overflow-hidden border border-border/50 shadow-2xl bg-card">
      {/* Header */}
      ...
      <div className="p-4 sm:p-6 space-y-4 sm:space-y-6">
        ...
        <div className="mb-4 sm:mb-6">
          <h3 className="text-sm sm:text-base font-semibold text-foreground mb-2">Type QR-code</h3>
          <p className="text-xs text-muted-foreground mb-3 sm:mb-4">Kies wat je met deze QR-code wilt doen.</p>

          {/* QR Type Grid */}
          <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-4 gap-3">
            {/* Tekst / notitie - Selected */}
            <div className="bg-card border-2 border-primary rounded-xl p-4 cursor-pointer hover:bg-[#151515] transition-colors">
            ...
            {/* Link / URL */}
            <div className="bg-muted/30 border border-[#1A1A1A] rounded-xl p-4 cursor-pointer hover:bg-[#151515] transition-colors">
        ...
        <div className="grid md:grid-cols-2 gap-4 sm:gap-6">
          ...
          <div className="space-y-4 sm:space-y-6">
            ...
            <div>
              ...
              <div className="bg-muted/30 border border-[#1A1A1A] rounded-lg p-3">
                <input
                  type="text"
            ...
            <div className="flex gap-3">
              ...
              <button type="button" aria-label="Reset formulier" className="px-4 bg-card hover:bg-[#151515] border border-[#1A1A1A] text-foreground text-sm font-semibold rounded-lg transition-colors">
                <svg className="w-4 h-4" fill="none" stroke="currentColor" viewBox="0 0 24 24">
          ...
          <div className="bg-muted/30 border border-[#1A1A1A] rounded-xl p-6 flex flex-col">
            ...
            <div className="space-y-3">
              <div className="flex items-center justify-between">
                ...
                <div className="flex gap-2">
                  <button type="button" aria-label="Download QR-code" className="p-1.5 bg-card hover:bg-[#151515] border border-[#1A1A1A] rounded transition-colors">
                    <svg className="w-3.5 h-3.5 text-muted-foreground" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                      <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M4 16v1a3 3 0 003 3h10a3 3 0 003-3v-1m-4-4l-4 4m0 0l-4-4m4 4V4" />
                    </svg>
                  </button>
                  <button type="button" aria-label="Deel QR-code" className="p-1.5 bg-card hover:bg-[#151515] border border-[#1A1A1A] rounded transition-colors">
                    <svg className="w-3.5 h-3.5 text-muted-foreground" fill="none" stroke="currentColor" viewBox="0 0 24 24">
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-4 pt-4">
          <div className="bg-muted/30 border border-[#1A1A1A] rounded-lg p-4">
